...
echo "<div style='background: #7b42bc; font-size: 40 ; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);'><p><strong>Terraform</strong> is AWESOME!</p></div>" | sudo tee /var/www/html/index.html
